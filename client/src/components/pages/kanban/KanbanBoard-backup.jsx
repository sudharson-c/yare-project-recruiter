...
export default function KanbanTasksBoardStatic() {
  ...
  const [project, setProject] = useState(null); // includes owner + collaborators
  ...
  // Load project details and project-scoped static board
  useEffect(() => {
    let cancelled = false;
  ...
  }, [selectedProjectId]); // uses existing project details route
